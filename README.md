# Curso de Programador Web - Camada 5305 💾
...
5. Luego ejecuten el comando `git remote add profe https://github.com/mpetrinidev/coderhouse-programadorweb-5305` para vincular su repo con el mio.
